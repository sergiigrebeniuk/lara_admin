...
</li></ol></fieldset><fieldset class="buttons"><ol><li class="commit button"><input class="create" id="admin_user_submit" name="commit" type="submit" value="Entrar" /></li></ol></fieldset>
