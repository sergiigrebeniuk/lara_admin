	...
	if(Input::get("format")!=null){
		if( in_array( Input::get("format"), $formats) ){
			switch (Input::get("format")) {
				case 'json':
					return View::make( "lara_admin::exporters.json", array("isDownload"=>$isDownload, "content"=> json_encode( $content )) );
				break;
				case 'xml':
					return View::make( "lara_admin::exporters.xml", array("isDownload"=>$isDownload, "content"=> $this->toXml( $content )) );
				break;
				case 'csv':
					return View::make( "lara_admin::exporters.csv", array("isDownload"=>$isDownload, "content"=> $this->array_to_scv( $content )) );
				break;
			}
		}
